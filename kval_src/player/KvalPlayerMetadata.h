#ifndef DESKTOPPLAYERMETADATA_H
#define DESKTOPPLAYERMETADATA_H
 ...
 * TODO: Music, Movie
 */
class KvalPlayerMetaData : public QObject
{
    Q_OBJECT
...
public:
    ...
    explicit KvalPlayerMetaData(QObject *parent = 0);
